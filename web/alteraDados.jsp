<%-- 
    Document   : alteraDados
    Created on : 06/08/2018, 14:40:02
    Author     : t7249320
--%>
...
<html>
    <head>
        ...
        <title>Dash Board - Atualizar Dados</title>
    ...
    <div class="container" id="rel"> 
        ...
        <div class="row"> <form  action="UpdateServlet" method="POST">
                <div class="panel panel-default">
                    ...
                    <table class="table" id="tbInci">
                        ...
                        <% incidenteDao inciDao = new incidenteDao();
                            ...
                            sist.setChamado(Integer.parseInt(saida));
                        ...
                        <tr>
                            ...
                            <td> <input name="cha" type="hidden" value="<%=sist.getChamado()%>"> <%=sist.getChamado()%> </td>
                    ...
                    <div class="row" id="updates">
                        ...
                        <div class="col-md-2">
                            <button type="submit" class="btn btn-success" name="cha" value="<%=s.getChamado()%>">Salvar</button>
                        </div>             
                    </div>
                </div>
            </form>
