<%-- 
    Document   : dashBoardBasic
    Created on : 05/04/2018, 11:37:31
    Author     : t7249320
--%>
                                ...
                                <div class= "col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="torreOP">
                                            ...
                                            <option value="Claro Movel">Micro-informatica</option>
                                            <option value="Claro Movel">Monitoria</option>
                                            <option value="Claro Movel">PDA Telecom</option>
                                            <option value="Claro Movel">Portabilidade</option>
                                            <option value="Claro Movel">Sistemas</option>
                                            <option value="Claro Movel">Web</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
